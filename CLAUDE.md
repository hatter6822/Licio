...
envelope (no container-conferred trust).  The remaining WS-S plane (the §9 P2P
...
`RTCPeerConnection` carrier + the WS-S.6.6 server rendezvous endpoint, WS-S.7–11
