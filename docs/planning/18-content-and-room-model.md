...
WS-Q is the room/content/visibility foundation that two **launch-relevant extension workstreams** (WS-R P1; **WS-S launch-blocking — ships with the product**, 2026-06 maintainer decisions) build on; both are **additive and non-breaking** to WS-Q's shipped model:
