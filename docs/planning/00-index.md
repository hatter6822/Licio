...
| `21-conversation-comments.md` | WS-T | M3 | P1 | 12 | 40 | Inline comment sections: comment-as-unit, evidence/correction enrichments, GIF uploads, SSE live comments, reply notifications, retire structured branches |
| **Total** | | | | | **~898** | Atomic tasks across 21 workstreams |
