...
| `19-offline-content-availability.md` | WS-R | M3+ ext | P3 | 10 | 77 | LCAP v0.2 delay-tolerant sync: deterministic CBOR/CID/COSE, detached-proof trust plane, lane scheduler, checkpoints/witnesses, liveness, manual bundle/QR/relay transports |
| `20-private-p2p-rooms.md` | WS-S | M3+ ext | P3 | 11 | 56 | E2EE member-hosted private rooms: server non-storage contract, MLS/HPKE/Ed25519, private Helia/libp2p, Lamport-ordered op-log reducer, blind rendezvous, update-channel transparency |
| **Total** | | | | | **~839** | Atomic tasks across 20 workstreams |
