...
| `19-decentralized-data-plane.md` (Part I) | WS-R | M3+ (elevated) | P1 | 8 | 99 | LCAP v0.2 delay-tolerant sync: deterministic CBOR/CID/COSE, detached-proof trust plane, lane scheduler, checkpoints/witnesses, liveness, and the **first-class transports** — manual bundle/QR/relay **+ WebTransport, WebRTC P2P, browser-IPFS public bridge, and native Capacitor courier** (elevated 2026-06) |
| `19-decentralized-data-plane.md` (Part II) | WS-S | M3+ ext | P3 | 11 | 62 | E2EE member-hosted private rooms: server non-storage contract, MLS/HPKE/Ed25519, private Helia/libp2p, Lamport-ordered op-log reducer, blind rendezvous, update-channel transparency |
