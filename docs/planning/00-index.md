...
WS-0 (Repository foundation) ── 01-repository-foundation.md
 ...
 ├── WS-R (Offline availability / LCAP v0.2; P1, elevated 2026-06 — first-class native courier + WebTransport/WebRTC/IPFS transports) [from OFFLINE_SPEC; depends on WS-C/D/E/F/G/Q — all complete] ── 19-offline-content-availability.md
