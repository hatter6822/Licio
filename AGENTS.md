...
│           │   │                             acceptance log + device-seq + fork evidence; in-memory
│           │   │                             adapter (the gated Drizzle/Postgres adapter is part 2)
