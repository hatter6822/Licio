...
apps/api                   (depends on @licio/shared, @licio/db,
                            ...
                            @licio/lcap, @licio/lcap-p2p; the lcap-p2p edge
                            is the Gate-19 public-block (re)publisher
                            ...
                            `check:lcap-p2p-split` code-split gate does not apply
                            to it; the import is a static server-side value
                            import and is budget-exempt as a `workspace:*` dep)
```
